 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://methods.soa_study.com/", wsdlLocation = "http://localhost:8080/lab_soa-web/HelloWorldImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://methods.soa_study.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab_soa-web/HelloWorldImpl?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://methods.soa_study.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://methods.soa_study.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
